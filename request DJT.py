...
path = '/trade-api/v2/markets/trades?limit=1000&ticker=PRES-2024-DJT'
headers = {
...
while path:
    ...
    if cursor:
        path = f'/trade-api/v2/markets/trades?cursor={cursor}&limit=1000&ticker=PRES-2024-DJT'
    else:
        break  # No more pages, exit loop


df.to_csv('/Users/jingzhao/Documents/找工quant/club/MFAMS/Kalshi Project/Donald Trump Data.csv')
print("Data saved to 'Donald Trump Data.csv'")
